...
async function main() {
  // Örnek kullanıcı id'leri (Clerk formatında)
  ...
  console.log("Companions created:", { c1: c1.name, c2: c2.name, c3: c3.name });

  // SessionHistory (her companion için bir oturum)
  ...
  // Bookmarks (userId1, c2 ve c3'ü bookmark'lasın; userId2, c1'i bookmark'lasın)
